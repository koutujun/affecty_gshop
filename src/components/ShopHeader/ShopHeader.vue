  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      <img class="content-image" :src="info.avatar">
        ...
        <h2 class="content-title" @click="showShopDetail=true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="showDiscount=true">
      <div class="discounts-left">
        <div class="activity" :class="activityStyle[info.supports[0].type]">
          <span class="content-tag">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showShopDetail">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showShopDetail = false">
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="showDiscount">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="activityStyle[support.type]" v-for="(support,index) in info.supports">
            <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="showDiscount = false">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
...
<script>
  ...
  export default {
    data (){
      return {
        showDiscount: false,  //是否显示优惠活动
        showShopDetail: false,  //是否显示商铺详情
        activityStyle: ['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState(['info'])
